...
public class OSInfoDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        TextView toxyc_version = content.findViewById(R.id.dev_info_toxyc_version);
        ...
        toxyc_version.setText(SystemProperties.get("ro.modversion"));
        ...
        LinearLayout toxyc_version_layout = content.findViewById(R.id.toxyc_version_layout);
        LinearLayout android_version_layout = content.findViewById(R.id.android_version_layout);
        toxyc_version_layout.setOnClickListener(new View.OnClickListener() {
            @Override
   ...
   public void updateVisibilities(View view) {
        ...
        LinearLayout toxyc_version_layout = view.findViewById(R.id.toxyc_version_layout);
        ...
        if (SystemProperties.get("ro.modversion").isEmpty()) {
            toxyc_version_layout.setVisibility(View.GONE);
        }
